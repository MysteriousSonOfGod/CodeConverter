...
:continue
  ...
  ::/verbosity:detailed
  MSBuild.exe /nologo /nowarn:MSB8012 /verbosity:quiet /p:DefineConstants="%definition%;%iniT%;%deinT%;%stT%;%isStrict%;%onTimerT%;%Hooking%;%conv_debug%";Configuration=Release "%currpath%MQL2FT\MQL2FT.vcxproj" >> build.log
